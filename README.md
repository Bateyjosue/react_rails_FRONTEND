...
# 📖 react_rails_FONTEND <a name="about-project"></a>

> Its a front end part of our Greeting API whereby we fetch and display an randon greeting
...
<details>
  ...
  <ul>
    <li><a href="https://react-rails-backend.onrender.com/api/v1">API Link</a></li>
  </ul>
</details>
<details>
...
- [Live Demo API Link](https://react-rails-backend.onrender.com/api/v1)
- [Backend Link](https://github.com/Bateyjosue/hello-rails-BACKEND.git)
...
```
  git clone https://github.com/Bateyjosue/react_rails_FRONTEND.git
  
  cd react_rails_FRONTEND
...
Then run the develelopment server
```
  yarn start
```
